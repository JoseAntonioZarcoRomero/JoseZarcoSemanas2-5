<?php
  ...
  if(!$con){
    ...
    if(isset($_GET['q'])){
      ...
      $query = $_GET['id'];
      $sql = "SELECT pok_id,pok_name,pok_height,pok_weight,pok_base_experience, type_name FROM pokemon NATURAL JOIN pokemon_types NATURAL JOIN types WHERE pok_id='$query' AND slot=1";
      $res = mysqli_query($con, $sql);
